...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException{
        try{
            ...
            if (dto.blocked()){
                var message = "O card %s está bloqueado! É necessário desbloquea-lo para o mover".formatted(cardId);
    ...
    public void cancel(final Long cardId, final Long cancelColumnId ,
        ...
        try{
            ...
            if (dto.blocked()){
                var message = "O card %s está bloqueado. É necessário desbloqueá-lo para o mover".formatted(cardId);
                throw new CardBlockedException(message);
            }
            var currentColumn = boardColumnsInfo.stream()
                    .filter(bc -> bc.id().equals(dto.columnId()))
